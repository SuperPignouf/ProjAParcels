/*
 * Code taken from "http://androidworkshop.tumblr.com/"
 */
...
public class NFCForegroundUtil {
	...
	public NFCForegroundUtil(Activity activity) {
	    ...
	    techListsArray = new String[][] { new String[] { NfcA.class.getName()} }; //, NfcV.class.getName(), NfcB.class.getName(), NfcF.class.getName() } };
